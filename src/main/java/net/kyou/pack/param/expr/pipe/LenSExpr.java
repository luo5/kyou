 ...
 * @author nuclearg
 */
@ExprTag(name = "lens", postfix = ExprPostfix.Empty, type = ExprType.Integer, require = ExprType.String)
class LenSExpr extends PipeExpr {
    LenSExpr(String expr, Param segment, Expr arg, Charset encoding) {
